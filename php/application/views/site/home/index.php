             ...
             <div class="tittle-box-center">
		      ...
		      <div class="box-content-center product"><!-- The box-content-center -->
		            ...
		            <div class="product_item">
                       ...
                       <div class="action">
                           <p style="float:left;margin-left:2px">Lượt xem: <b><?php echo $row->view?></b></p>
             ...
             <div class="tittle-box-center">
		      ...
		      <div class="box-content-center product"><!-- The box-content-center -->
		            ...
		            <div class="product_item" >
                       ...
                       <p class="price" style="width: 175px;">
                              <?php if($row->discount > 0):?>
                              <?php $price_new = $row->price - $row->discount;?>
                              <?php echo number_format($price_new)?> đ <span class="price_old"><?php echo number_format($row->price)?> đ</span>
				              <?php else:?>
                       ...
                       <div class="action">
                           <p style="float:left;margin-left:10px">Lượt mua: <b>50 san pham</b></p>
	                       <a title="Mua ngay" href="<?php echo base_url('product/view/'.$row->id)?>" class="button" >Mua ngay</a>
	                       <div class="clear"></div>
                       </div>
                   </div>
