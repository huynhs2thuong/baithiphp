...
jQuery('document').ready(function(){
    ...
    'file': 'https://www.youtube.com/watch?v=pXWGnRtr6zU',
    'controlbar': 'bottom',
    'width': '560',
    'height': '315',
    'autoplay' : true
		      ...
		      <div class="box-content-center product"><!-- The box-content-center -->
		           <div class='product_view_img'>
		                <a href="<?php echo base_url('upload/product/'.$product->image_link)?>" class="jqzoom" rel='gal1'  title="triumph" >
				            <img  src="<?php echo base_url('upload/product/'.$product->image_link)?>" alt='' style="width:280px  !important" height="300px">
				        </a>
...
<div class="usual" id="usual1">
     <ul>
	       <li><a title="Chi tiết sản phẩm" rel='tab2' href='javascript:void(0)' class="tab selected">Phản hồi</a></li>
