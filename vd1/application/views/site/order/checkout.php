             ...
             <div><h2>Thông tin nhận hàng</h2>
		      ...
		      <div class="box-content-center product"><!-- The box-content-center -->
		            <form class="t-form form_action" method="post" action="<?php echo site_url('order/checkout')?>" enctype="multipart/form-data">
        				  ...
        				  <div class="form-row">
        						<label for="param_address" class="form-label">Địa chỉ nhận hàng:<span class="req">*</span></label>
        						<div class="form-item">
        				  ...
        				  <div class="form-row">
        						...
        						<div class="form-item">
        				           	<input type="submit"  onclick="alert('Bạn đã đặt hàng thành công, chúng tôi sẽ kiểm tra và gửi hàng cho bạn')"class="button" value="Thanh toán" name="submit">
        						</div>
        				   </div>
                    </form>
		            <div class="clear"></div>
